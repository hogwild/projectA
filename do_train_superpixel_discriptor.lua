...
----build the superpixel descriptor
dofile '1_feature_generate.lua'
dofile '2_build_superpixel_descriptor.lua'
dofile '3_loss_set_superpixel_descriptor.lua'
dofile '4_train_superpixel_descriptor.lua'
dofile '5_test_descriptor.lua'
